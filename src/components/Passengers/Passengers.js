...
const passengers = props => {
  ...
  if (props.passengers.length) {
    if (props.checkIn) {
      ...
      passengerList = props.passengers.filter(
  ...
  else passengers = <div>No passengers available in the list to display.</div>;
  return <div className="pasngr-list-cont">{passengers}</div>;
};
